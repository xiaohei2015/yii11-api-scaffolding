...
class Curl
{
    ...
    public function exec($url, $options, $debug = false)
    {
        ...
        //log
        Yii::log("TYPE:CURL:".$url."|params:".CJSON::encode($options), "warning", "curl");
        ...
        if(!$output){
            ...
            Yii::log("RETURN:".$output.", ERROR:".$this->_error.", INFO:".CJSON::encode($this->_info).", PID:".getmypid(), "warning", "curl");
        }
        else if($debug)
            $this->_info = curl_getinfo($ch);
        ...
        //log
        Yii::log("RETURN:".$output, "info", "curl");
     ...
     * @param type $url
     */
    public function postByJson($url, $data) {
        Yii::log("Begin to request to URL:".$url.", INFO:".CJSON::encode($data).", PID:".getmypid(), "warning", "curl");
        ...
        Yii::log("End to request to URL:".$url.", INFO:".CJSON::encode($data).", RESPONSE:".CJSON::encode($res), "warning", "curl");
        return $res;
    }
