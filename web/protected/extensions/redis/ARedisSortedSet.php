...
class ARedisSortedSet extends ARedisIterableEntity {
	 ...
	 * @return array the members in the set
	 */
	public function getDataByScore($start,$end) {
		return	$this->_data = $this->getConnection()->getClient()->zRangeByScore($this->name,$start,$end, []);
	}
        ...
        public function expire($expire){
            return  $this->getConnection()->getClient()->expire($this->name,$expire);
        }
}